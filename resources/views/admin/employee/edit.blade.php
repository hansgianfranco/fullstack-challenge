            ...
            <div class="panel-body">
                <form role="form" method="post" action="{{ route('employee.update', $employee->id) }}">
                    ...
                    {{--<div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                        <label>Usuario</label>
                        <input name="username" type="text" class="form-control" value="{{ $employee->username }}">
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('since') ? ' has-error' : '' }}">
                        ...
                        <input name="since" type="date" class="form-control" value="{{ $employee->since }}">
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('division') ? ' has-error' : '' }}">
                        ...
                        <select name="division" class="form-control">
                            ...
                            @foreach($divisions as $key => $value)
                                <option value="{{ $key }}" {{ $employee->division == $key ? 'selected' : '' }}>{{ $value }}</option>
                            @endforeach
                        </select>
                    </div>
